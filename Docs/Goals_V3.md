...
**Project Goal**
The end goal of this project is to create a product that ranks all coaches possible by way of a defensible analytical result and gathers a variety of data that would be useful for teams for hiring decisions into one place.
