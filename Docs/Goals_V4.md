...
Potential solution: finding more sources of data, scraping from years farther back, or considering additional data types like if coaches have history as a player.