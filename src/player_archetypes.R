...
if (!exists("ss_pl_season_ids")) {
  ss_pl_season_ids <- c(
    ...
    "2023" = 52186, "2024" = 61627, "2025" = 76986
  )
}
...
# The SofaScore-covered seasons, derived from the id table above so the mirror
# and source_sofascore.r can never disagree about the span.
